...
export const INITIAL_PRODUCTION_COMPANIES = [
  ...
  {
    name: 'Lionsgate',
    description: 'Canadian-American entertainment company',
    homepage: 'https://www.lionsgate.com',
  ...
  },
  {
    ...
    homepage: 'https://studios.amazon.com',
    headquarters: 'Culver City, California, United States',
    origin_country: 'US',
    parent_company: 'Amazon',
    original_id: 35942,
  ...
  },
  {
    ...
    homepage: 'https://www.apple.com/tv-pr',
    headquarters: 'Culver City, California, United States',
    origin_country: 'US',
  ...
  },
  {
    ...
    description: 'British film production company based in London',
    homepage: 'https://www.workingtitlefilms.com',
  ...
  },
  {
    ...
    homepage: 'https://www.legendary.com',
    headquarters: 'Burbank, California, United States',
    origin_country: 'US',
  ...
  },
  {
    ...
    description: 'American film and television production company',
    homepage: 'https://www.blumhouse.com',
    headquarters: 'Los Angeles, California, United States',
    origin_country: 'US',
    parent_company: null,
    original_id: 3172,
  ...
  },
  {
    name: 'Focus Features',
    description: 'American film production and distribution company',
    homepage: 'https://www.focusfeatures.com',
    headquarters: 'Los Angeles, California, United States',
    origin_country: 'US',
    parent_company: 'NBCUniversal',
    original_id: 10146,
